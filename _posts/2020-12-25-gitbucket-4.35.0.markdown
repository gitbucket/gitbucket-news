...
> GitBucket 4.35.0 has a database migration issue which happens if webhook has been configured. Please use [4.35.1](https://github.com/gitbucket/gitbucket/releases/tag/4.35.1) instead.
