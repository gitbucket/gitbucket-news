...
> GitBucket 4.35.0 has a database migration issue which happens if webhook has been configured, and a binary compatibility issue in the bundled notifications plugin. Please use [4.35.2](https://github.com/gitbucket/gitbucket/releases/tag/4.35.2) instead.
