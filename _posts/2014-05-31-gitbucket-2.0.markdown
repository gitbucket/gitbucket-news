...
---
Today, we are pleased to announce the availability of new version of Scala based Github clone [GitBucket 2.0](https://github.com/gitbucket/gitbucket/releases/tag/2.0)!
