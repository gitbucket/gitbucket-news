...
Today, we are pleased to announce the availability of new version of Scala based GitHub clone [GitBucket 2.5](https://github.com/gitbucket/gitbucket/releases/tag/2.5)!
