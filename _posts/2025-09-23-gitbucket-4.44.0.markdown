...
In previous versions, GitBucket's branch protection only supported the following restrictions, and the standard functionality can't prevent direct pushes to branches.
